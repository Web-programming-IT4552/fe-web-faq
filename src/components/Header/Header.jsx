...
function Header(props) {
    ...
    return (<div className="faq-header">
        ...
        <div className="faq-header__utils">
            <div className="faq-header__search">
                {viewport.width >= 1000 ? (<InputSearch eventFn={toSearchPage}/>) : (
                    <div className="search-mini" onClick={expandSearchBox}>
                        <Icon name="search" sizeText="medium"/>
                    </div>)}
            </div>
            {checkLogin ? (<>
                <Link to="/"><Icon name="notification" sizeText="medium"/></Link>
                <Link to="/"><Icon name="message" sizeText="medium"/></Link>
                <Link to="/write">
            ...
            {checkLogin ? (<div onClick={() => setOpen(!open)}>
        ...
        {viewport.width < 1000 && (<div ref={searchExpand} className="faq-search__input-box">
            <input
                type="text"
